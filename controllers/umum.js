...
const updatePersonUmum = async (req, res) => {
  ...
  if (
    ...
    unauthorizedLogger.warn(
      `${req.method} ${req.url} [umumController] Unauthorized singlePersonUmum ${singlePersonUmum.nama} tampering by {kp: ${req.user.kp}, kodFasiliti: ${req.user.kodFasiliti}} from ${req.ip}`
    );
