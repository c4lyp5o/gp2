...
const countAdHocQuery = async (payload) => {
  const { negeri, daerah, tarikhMula, tarikhAkhir, checkboxSelection } =
    payload;
  ...
  const outputAdhoc = {
    ...
    ...(extractCheckboxY.some((i) => i.value === 'jumlahBukanWarganegara') && {
    ...
    ...(extractCheckboxY.some((i) => i.value === 'jumlahPerluDenturPenuh') && {
    ...
    ...(extractCheckboxY.some((i) => i.value === 'jumlahPerluDenturSepara') && {
    ...
    ...(extractCheckboxY.some((i) => i.value === 'jumlahPesakitPrrJenis1') && {
      jumlahPesakitPrrJenis1: {
        $sum: {
          $cond: [
            {
    ...
    ...(extractCheckboxY.some((i) => i.value === 'tampalanPostAmgGdSemula') && {
      tampalanPostAmgGdSemula: {
        $sum: '$gdSemulaPosteriorAmalgamJumlahTampalanDibuatRawatanUmum',
      },
    }),
    ...
    ...(extractCheckboxY.some((i) => i.value === 'tampalanPostAmgGkSemula') && {
      tampalanPostAmgGkSemula: {
        $sum: '$gkSemulaPosteriorAmalgamJumlahTampalanDibuatRawatanUmum',
      },
    }),
  ...
  const bucket_template = {
    $bucket: {
      groupBy: '$umur',
      boundaries: [
        0, 1, 5, 7, 10, 13, 15, 18, 20, 30, 40, 50, 60, 61, 65, 66, 70, 75, 150,
      ],
      default: 'Other',
      output: {
        ...outputAdhoc,
