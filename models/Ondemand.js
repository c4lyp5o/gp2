...
const ondemandSchema = new Schema(
  {
    ...
    LiputanOAP: { type: Boolean, required: true, default: false },
    'UTCRTC-Kelantan': { type: Boolean, required: true, default: false },
    RTC: { type: Boolean, required: true, default: false },
    UTCRTC: { type: Boolean, required: true, default: false },
