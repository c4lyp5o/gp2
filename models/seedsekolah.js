...
const newSekolah = [
  ...
  new Sekolah({
    ...
    umur: '15',
    ic: '123456789',
    namaSekolah: 'Sekolah Menarik Tinggi',
    darjah: '0',
    tingkatan: '3',
    kelas: 'Amanah',
    // enrolmen: '',
  ...
  new Sekolah({
    ...
    umur: '15',
    ic: '123456789',
    namaSekolah: 'Sekolah Menarik Alor Janggus',
    darjah: '0',
    tingkatan: '3',
    kelas: 'Siddiq',
    // enrolmen: '',
  ...
  new Sekolah({
    ...
    umur: '9',
    ic: '123456789',
    namaSekolah: 'Sekolah Rendah Alor Janggus',
    darjah: '3',
    tingkatan: '0',
    kelas: 'Mahmud',
    // enrolmen: '',
...
newSekolah.map(async (p, index) => {
  await p.save((err, result) => {
    if (index === newSekolah.length - 1) {
      console.log('DONE!');
      mongoose.disconnect();
    }
  });
