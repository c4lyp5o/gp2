...
const FormTambahProgramGtod = ({
  ...
  return (
    <>
      {isLoadingForm ? (
        <div className='grid grid-cols-2 auto-rows-min gap-5 mx-10 border border-user1 rounded-lg shadow-sm py-10 px-8'>
          <span className='h-6 bg-user1 bg-opacity-50 animate-pulse w-full px-20 rounded-xl'></span>
          <span className='h-6 bg-user1 bg-opacity-50 animate-pulse w-full px-20 rounded-xl'></span>
          <span className='h-6 bg-user1 bg-opacity-50 animate-pulse w-full px-20 rounded-xl'></span>
          <span className='h-6 bg-user1 bg-opacity-50 animate-pulse w-full px-20 rounded-xl'></span>
          <span className='h-6 bg-user1 bg-opacity-50 animate-pulse w-full px-20 rounded-xl'></span>
