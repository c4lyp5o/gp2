...
import { addSM, getKP, getCurrentUser } from "../../controllers/helper";
        ...
        <div className={styles.centered}>
          <div className={styles.modalAdd}>
            <div className={styles.modalHeader}>
              <h5 className={styles.heading}>TAMBAH SEKOLAH MENENGAH</h5>
            </div>
            <button
