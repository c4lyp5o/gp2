          ...
          {showInfo && (
            <div className='z-100 absolute float-right box-border outline outline-1 outline-userBlack m-5 p-5 bg-userWhite top-10 left-1'>
              <div className='text-xs'>
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].facebook
                    .length > 0
                    ? props.data[dataIndex].data[
                        internalDataIndex
                      ].facebook.map((i) => {
                        if (i === '') return null;
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].youtube
                    .length > 0
                    ? props.data[dataIndex].data[internalDataIndex].youtube.map(
                        (i) => {
                          if (i === '') return null;
                          return Object.keys(i).map((key) => {
                            return (
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].instagram
                    .length > 0
                    ? props.data[dataIndex].data[
                        internalDataIndex
                      ].instagram.map((i) => {
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].twitter
                    .length > 0
                    ? props.data[dataIndex].data[internalDataIndex].twitter.map(
                        (i) => {
                          if (i === '') return null;
                          return Object.keys(i).map((key) => {
                            return (
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].tiktok.length >
                  0
                    ? props.data[dataIndex].data[internalDataIndex].tiktok.map(
                        (i) => {
                          if (i === '') return null;
                          return Object.keys(i).map((key) => {
                            return (
                ...
                <div className='mt-2'>
                  {props.data[dataIndex].data[internalDataIndex].lainLain
                    .length > 0
                    ? props.data[dataIndex].data[
                        internalDataIndex
                      ].lainLain.map((i) => {
