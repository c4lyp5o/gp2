...
rowNew1.getCell(4).value = results.sapuanFluoridaBaru; //D16      Bawah 1 tahun baru
rowNew1.getCell(5).value = results.prrJenis1Baru; //E16      Bawah 1 tahun baru
...
rowNew2.getCell(4).value = results.sapuanFluoridaBaru; //D17      Bawah 1 tahun ulangan
rowNew2.getCell(5).value = results.prrJenis1Baru; //E17      Bawah 1 tahun ulangan
...
rowNew3.getCell(4).value = results.sapuanFluoridaBaru; //D18      1 hingga 4 tahun baru
rowNew3.getCell(5).value = results.prrJenis1Baru; //E18      1 hingga 4 tahun baru
...
rowNew4.getCell(4).value = results.sapuanFluoridaBaru; //D19      Bawah 1 tahun
rowNew4.getCell(5).value = results.prrJenis1Baru; //E19      Bawah 1 tahun
...
rowNew.getCell(4).value = results.sapuanFluoridaBaru; //D20      5 hingga 6 tahun
rowNew.getCell(5).value = results.prrJenis1Baru; //E20      5 hingga 6 tahun
rowNew.getCell(6).value = results.muridBaruFS; //F20      5 hingga 6 tahun
rowNew.getCell(7).value = results.muridUlanganFS; //G20      5 hingga 6 tahun
rowNew.getCell(8).value = results.gigiBaruFS; //H20      5 hingga 6 tahun
rowNew.getCell(9).value = results.gigiUlanganFS; //I20      5 hingga 6 tahun
rowNew.getCell(10).value = results.tampalanAntGdBaru; //J20      5 hingga 6 tahun
rowNew.getCell(11).value = results.tampalanAntGdUlangan; //K20      5 hingga 6 tahun
rowNew.getCell(12).value = results.tampalanAntGkBaru; //L20      5 hingga 6 tahun
rowNew.getCell(13).value = results.tampalanAntGkUlangan; //M20      5 hingga 6 tahun
rowNew.getCell(14).value = results.tampalanPostGdBaru; //N20      5 hingga 6 tahun
rowNew.getCell(15).value = results.tampalanPostGdUlangan; //O20      5 hingga 6 tahun
rowNew.getCell(16).value = results.tampalanPostGkBaru; //P20      5 hingga 6 tahun
rowNew.getCell(17).value = results.tampalanPostGkUlangan; //Q20      5 hingga 6 tahun
rowNew.getCell(18).value = results.tampalanPostAmgGdBaru; //R20      5 hingga 6 tahun
rowNew.getCell(19).value = results.tampalanPostAmgGdUlangan; //S20      5 hingga 6 tahun
rowNew.getCell(20).value = results.tampalanPostAmgGkBaru; //T20      5 hingga 6 tahun
rowNew.getCell(21).value = results.tampalanPostAmgGkUlangan; //U20      5 hingga 6 tahun
rowNew.getCell(22).value = results.jumlahTampalanBaru; //V20      5 hingga 6 tahun
rowNew.getCell(23).value = results.jumlahTampalanUlangan; //W20      5 hingga 6 tahun
rowNew.getCell(24).value = results.tampalanSementara; //X20      5 hingga 6 tahun
rowNew.getCell(25).value = results.cabutanGd; //Y20      5 hingga 6 tahun
rowNew.getCell(26).value = results.cabutanGk; //Z20      5 hingga 6 tahun
rowNew.getCell(27).value = results.penskaleran; //AA20      5 hingga 6 tahun
rowNew.getCell(28).value = results.kesSelesai; //AB20      5 hingga 6 tahun
rowNew.getCell(29).value = results.rokokSaringNasihat; //AC20      5 hingga 6 tahun
rowNew.getCell(30).value = results.rokokIntervensi; //AD20      5 hingga 6 tahun
rowNew.commit();
...
rowNew6.getCell(4).value = results.sapuanFluoridaBaru; //D21      5 hingga 6 tahun ulangan
rowNew6.getCell(5).value = results.prrJenis1Baru; //E21      5 hingga 6 tahun ulangan
...
rowNew7.getCell(4).value = results.sapuanFluoridaBaru; //D22      7 hingga 9 tahun baru
rowNew7.getCell(5).value = results.prrJenis1Baru; //E22      7 hingga 9 tahun baru
...
rowNew8.getCell(4).value = results.sapuanFluoridaBaru; //D23      7 hingga 9 tahun ulangan
rowNew8.getCell(5).value = results.prrJenis1Baru; //E23      7 hingga 9 tahun ulangan
...
rowNew9.getCell(4).value = results.sapuanFluoridaBaru; //D24      10 hingga 12 tahun baru
rowNew9.getCell(5).value = results.prrJenis1Baru; //E24      10 hingga 12 tahun baru
...
rowNew10.getCell(4).value = results.sapuanFluoridaBaru; //D25      10 hingga 12 tahun ulangan
rowNew10.getCell(5).value = results.prrJenis1Baru; //E25      10 hingga 12 tahun ulangan
...
rowNew11.getCell(4).value = results.sapuanFluoridaBaru; //D26      13 hingga 14 tahun baru
rowNew11.getCell(5).value = results.prrJenis1Baru; //E26      13 hingga 14 tahun baru
...
rowNew12.getCell(4).value = results.sapuanFluoridaBaru; //D27      13 hingga 14 tahun ulangan
rowNew12.getCell(5).value = results.prrJenis1Baru; //E27      13 hingga 14 tahun ulangan
...
rowNew13.getCell(4).value = results.sapuanFluoridaBaru; //D28      15 hingga 17 tahun baru
rowNew13.getCell(5).value = results.prrJenis1Baru; //E28      15 hingga 17 tahun baru
...
rowNew14.getCell(4).value = results.sapuanFluoridaBaru; //D29      15 hingga 17 tahun ulangan
rowNew14.getCell(5).value = results.prrJenis1Baru; //E29      15 hingga 17 tahun ulangan
...
rowNew15.getCell(4).value = results.sapuanFluoridaBaru; //D28      Orang kurang upaya baru
rowNew15.getCell(5).value = results.prrJenis1Baru; //E28      Orang kurang upaya baru
...
rowNew16.getCell(4).value = results.sapuanFluoridaBaru; //D33      Orang kurang upaya ulangan
rowNew16.getCell(5).value = results.prrJenis1Baru; //E33      Orang kurang upaya ulangan
...
rowNew17.getCell(4).value = results.sapuanFluoridaBaru; //D34      Bukan warganegara Baru
rowNew17.getCell(5).value = results.prrJenis1Baru; //E34      Bukan warganegara Baru
...
rowNew18.getCell(4).value = results.sapuanFluoridaBaru; //D34      Bukan warganegara Ulangan
rowNew18.getCell(5).value = results.prrJenis1Baru; //E34      Bukan warganegara Ulangan
