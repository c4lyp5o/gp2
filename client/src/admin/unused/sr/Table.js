  ...
  return (
    <div className="flex flex-col items-center gap-5">
      <h1 className="text-3xl font-bold">
        Senarai Sekolah Rendah Daerah {daerah}
      </h1>
      <table className="table-auto border-collapse border border-slate-500">
        <thead>
          <tr>
            ...
            <th className="border border-slate-600 px-20">Nama Klinik</th>
            <th className="border border-slate-600 px-10">Manage</th>
          </tr>
        </thead>
      ...
      {addOpen && <AddModal setAddOpen={setAddOpen} jenisFacility="sr" />}
    </div>
  );
}
