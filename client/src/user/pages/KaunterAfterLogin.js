...
function KaunterAfterLogin() {
  ...
  return (
    <>
      ...
      <div className='absolute inset-2 top-[7.5rem] bottom-[2rem] -z-10 bg-kaunterWhite text-center justify-center items-center outline outline-1 outline-kaunterBlack rounded-md shadow-xl capitalize'>
        <Routes>
