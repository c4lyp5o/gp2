                  ...
                  <div className='text-xs overflow-y-auto'>
                    ...
                    {data.penskaleranSekolahRawatan ? (
                      <div className='grid grid-cols-[1fr_2fr]'>
                        ...
                        <p className='p-1 flex flex-col justify-start text-left border-y border-y-user1 border-opacity-10'>
                          {data.penskaleranSekolahRawatan === true ? (
                            <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                          ) : (
                            <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                          )}
                    ...
                    {data.rujukKlinikSekolahRawatan ? (
                      <div className='grid grid-cols-[1fr_2fr]'>
                        <p className='p-1 flex justify-end text-right bg-user1 bg-opacity-5'>
                        ...
                        <p
                          className='
                          p-1 flex flex-col justify-start text-left border-y border-y-user1 border-opacity-10'
                        >
                          {data.rujukKlinikRawatanEndo ? (
                            <p>
                              Pesakit Dirujuk Rawatan Endo:
                              {data.rujukKlinikRawatanEndo === true ? (
                                <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                              ) : (
                                <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                              )}
                          ...
                          {data.rujukKlinikCabutanGigiKekal ? (
                            <p>
                              Pesakit Dirujuk Cabutan Gigi Kekal:
                              {data.rujukKlinikCabutanGigiKekal === true ? (
                                <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                              ) : (
                                <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                              )}
                          ...
                          {data.rujukKesTrauma ? (
                            <p>
                              Pesakit Dirujuk Kes Trauma:
                              {data.rujukKesTrauma === true ? (
                                <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                              ) : (
                                <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                              )}
                          ...
                          {data.rujukMasalahKesihatan ? (
                            <p>
                              Pesakit Dirujuk Masalah Kesihatan:
                              {data.rujukMasalahKesihatan === true ? (
                                <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                              ) : (
                                <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                              )}
                          ...
                          {data.rujukBukanWarganegara ? (
                            <p>
                              Pesakit Dirujuk Kerana Bukan Warganegara:
                              {data.rujukBukanWarganegara === true ? (
                                <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                              ) : (
                                <FaTimesCircle className='text-user9 text-center mx-1 inline-flex' />
                              )}
                          ...
                          {data.rujukLainLain ? (
                            <p>
                              Pesakit Dirujuk Lain-lain:
                              <p>
                                {data.rujukLainLain && data.rujukLainLanjutan}
                                {data.rujukLainLanjutan && (
                                  <FaCheckCircle className='text-user7 text-center mx-1 inline-flex' />
                                )}
                              </p>
                            </p>
                    ...
                    data.rujukPakarPatologiSekolahRawatan ||
                    data.rujukPakarRestoratifSekolahRawatan ||
                    data.rujukPakarBedahMulutSekolahRawatan ||
                    data.rujukPakarPediatrikSekolahRawatan ? (
                      <div className='grid grid-cols-[1fr_2fr]'>
                        <p className='p-1 flex justify-end text-right bg-user1 bg-opacity-5'>
                          Rujukan :
                        </p>
                        <p className='p-1 flex flex-col justify-start text-left border-y border-y-user1 border-opacity-10'>
                          <a>
                            {data.rujukRawatanOrtodontikSekolahRawatan === true
