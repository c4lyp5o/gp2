...
export default function RegisterFMRModal({
  setModalRegisterSekolah,
  currentKodSekolah,
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const regbaru = await axios.get(
        `/api/v1/kohort/fmr/daftar?kodSekolah=${currentKodSekolah}`,
        {
          headers: {
      ...
      >
        ...
        <div className='mt-5 mx-5 p-1'>
          <span className='font-semibold'>
            Anda YAKIN untuk mendaftar maklumat kohort murid tahun 1? Maklumat
            yang didaftarkan tidak boleh diubah!{' '}
          </span>
          <div className='mt-2'>
