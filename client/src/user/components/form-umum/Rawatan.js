                      ...
                      <article className='grid grid-cols-1 gap-2 border border-userBlack pl-3 p-2 rounded-md auto-rows-min'>
                        ...
                        <div className='flex flex-row items-center pl-5 m-1'>
                          <input
                            ...
                            checked={
                              props.rawatanLainPeriodontik ? true : false
                            }
                            onChange={() => {
                      ...
                      <article className='grid grid-cols-[2fr_1fr] gap-2 border border-userBlack pl-3 p-2 rounded-md auto-rows-min'>
                        ...
                        <div className='flex flex-row items-center pl-5'>
                          <input
                            ...
                            checked={
                              props.penskaleranRawatanUmum ? true : false
                            }
                            onChange={() => {
                      ...
                      <article className='grid grid-cols-1 gap-2 border border-userBlack pl-3 p-2 rounded-md auto-rows-min'>
                        ...
                        <div className='flex flex-row items-center pl-5 m-1'>
                          <input
                            ...
                            checked={
                              props.rujukanPakarOrtodontik ? true : false
                            }
                            onChange={() => {
                        ...
                        <div className='flex flex-row items-center pl-5 m-1'>
                          <input
                            ...
                            checked={
                              props.rujukanPakarBedahMulut ? true : false
                            }
                            onChange={() => {
                    ...
                    <article className='grid grid-cols-1 gap-2 border border-userBlack pl-3 p-2 rounded-md auto-rows-min'>
                      ...
                      <div className='flex flex-row items-center pl-5 m-1'>
                        <input
                          ...
                          checked={
                            props.rawatanDibuatOperatorLain ? true : false
                          }
                          onChange={() => {
