...
export default function UserRetenSalahModal({
  ...
  const [reasonForRetenSalah, setReasonForRetenSalah] = useState('');
    ...
    await toast
      ...
      .then((res) => {
        if (res.data.msg === 'OTP verified') {
          handleRetenSalah(id, reasonForRetenSalah);
          ...
          <span className='font-semibold'>
            ...
            {statusReten === 'telah diisi' && (
              <span className='lowercase'>
                untuk menanda reten <span className='uppercase'>{nama}</span>{' '}
                sebagai <span className='uppercase'>salah</span>?
              </span>
            )}
              ...
              <div className='mt-5'>
                ...
                <div className='mt-5'>
                  ...
                  <input
                    ...
                    onChange={(e) => setReasonForRetenSalah(e.target.value)}
                  />
                </div>
                <div className='mt-5'>
